using ApiCatalogoJogosRafa.Entities;
using System;
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;

namespace ApiCatalogoJogosRafa.Repositories
{
    public class JogoRepository : IJogoRepository
    {
        ...
        {
            //Skip pula e Take pega quantidade
        ...
        public Task<Jogo> Obter(Guid id)
        {
            ...
            //Task.FromResult como não tem conexao com dados porque é mocado, ele cria uma task do tipo que esta passando e retorna.
        ...
        {
            //exemplo pra entender como varia sem usar o Linq
        ...
        public void Dispose()
        {
            ...
            //Como está tudo em memoria esse não usaria agora
        }
    }
}
