...
namespace ApiCatalogoJogosRafa.Controllers.V1
{
    ...
    public class CicloDeVidaIDController : ControllerBase
    {
        ...
        //scoped é uma instancia que perdura por toda requisição, ou seja a instancia vai ser igual para o mesmo request. Ou seja se no service e no repository recebe a mesma injeção de dependencia a instancia vai ser igual para o mesmo request.
        public readonly IExemploScoped _exemploScoped1;
        public readonly IExemploScoped _exemploScoped2;

        //transient para cada injeção ele vai te dar uma instancia nova.
